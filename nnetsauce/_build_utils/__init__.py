...
def _check_cython_version():
    message = (
        ...
        "to build a nnetsauce from source."
...
def cythonize_extensions(top_path, config):
    ...
    # check simple compilation with OpenMP. If it fails nnetsauce will be
    ...
    # The result of this check is cached as a private attribute on the nnetsauce
    # module (only at build-time) to be used twice:
    # - First to set the value of NNETSAUCE_OPENMP_PARALLELISM_ENABLED, the
    ...
    nnetsauce._OPENMP_SUPPORTED = check_openmp_support()
    ...
    config.ext_modules = cythonize(
        ...
        nthreads=n_jobs,
        compile_time_env={
            "NNETSAUCE_OPENMP_PARALLELISM_ENABLED": nnetsauce._OPENMP_SUPPORTED
        },
