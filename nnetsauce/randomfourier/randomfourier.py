...
def _get_estimator_type(estimator):
    ...
    elif hasattr(estimator, 'predict_proba') or hasattr(estimator, 'decision_function'):
        return 'classifier'
...
class RandomFourierEstimator(BaseEstimator):
    def __init__(self, estimator, n_components=100, gamma=1.0, random_state=None):
        """
    ...
    def partial_fit(self, X, y, classes=None):
        ...
        if hasattr(self.estimator, 'partial_fit'):
            ...
            raise ValueError(f"The estimator {type(self.estimator).__name__} does not support partial_fit method.")
    ...
    def predict_proba(self, X):
        ...
        """
        if not hasattr(self, '_estimator_type') or self._estimator_type != 'classifier':
            raise AttributeError("predict_proba is not available for this estimator type.")
        
        check_is_fitted(self, ['rff_'])
        X = check_array(X)
        
        if not hasattr(self.estimator, 'predict_proba'):
            raise ValueError(f"The estimator {type(self.estimator).__name__} does not support predict_proba.")
    ...
    def predict_log_proba(self, X):
        ...
        """
        if not hasattr(self, '_estimator_type') or self._estimator_type != 'classifier':
            raise AttributeError("predict_log_proba is not available for this estimator type.")
        
        check_is_fitted(self, ['rff_'])
        X = check_array(X)
        
        if not hasattr(self.estimator, 'predict_log_proba'):
            raise ValueError(f"The estimator {type(self.estimator).__name__} does not support predict_log_proba.")
    ...
    def decision_function(self, X):
        ...
        """
        if not hasattr(self, '_estimator_type') or self._estimator_type != 'classifier':
            raise AttributeError("decision_function is not available for this estimator type.")
        
        check_is_fitted(self, ['rff_'])
        X = check_array(X)
        
        if not hasattr(self.estimator, 'decision_function'):
            raise ValueError(f"The estimator {type(self.estimator).__name__} does not support decision_function.")
    ...
    def classes_(self):
        ...
        if hasattr(self, '_estimator_type') and self._estimator_type == 'classifier':
            ...
            raise AttributeError("classes_ is not available for this estimator type.")
    ...
    def set_params(self, **params):
        ...
        for param, value in params.items():
            ...
            elif param in ['estimator', 'n_components', 'gamma', 'random_state']:
        ...
        if hasattr(self, 'rff_') and ('n_components' in our_params or 'gamma' in our_params or 'random_state' in our_params):
