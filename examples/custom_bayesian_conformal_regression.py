...
print(f"Elapsed: {time() - start}s")
preds5 = regr5.predict(X_test, method="splitconformal", return_pi=True)
...
print(f"Elapsed: {time() - start}s")
preds6 = regr6.predict(X_test, method="splitconformal", return_pi=True)
...
regr3.fit(X_train, y_train)
print(f"Elapsed: {time() - start}s")
preds3 = regr3.predict(X_test, method="splitconformal", return_pi=True)
...
regr4 = ns.CustomRegressor(ARDRegression(), type_pi="bootstrap", replications=100)
start = time()
regr4.fit(X_train, y_train)
print(f"Elapsed: {time() - start}s")
preds4 = regr4.predict(X_test, method="splitconformal", return_pi=True, level=90)
print(f"coverage_rate conformalized ARD Regressor (bootstrap): {np.mean((preds4.lower<=y_test)*(preds4.upper>=y_test))}")


regr4 = ns.CustomRegressor(ARDRegression(), type_pi="kde", replications=100)
start = time()
regr4.fit(X_train, y_train)
print(f"Elapsed: {time() - start}s")
preds4 = regr4.predict(X_test, method="splitconformal", return_pi=True, level=90)
print(f"coverage_rate conformalized ARD Regressor (KDE): {np.mean((preds4.lower<=y_test)*(preds4.upper>=y_test))}")
regr4.fit(X_train, y_train)
...
print(f"Elapsed: {time() - start}s")
preds4 = regr4.predict(X_test, method="localconformal", return_pi=True, level=90)
print(f"coverage_rate conformalized ARD Regressor (localconformal): {np.mean((preds4.lower<=y_test)*(preds4.upper>=y_test))}")
regr4.fit(X_train, y_train)
